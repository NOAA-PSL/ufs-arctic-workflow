...
3. Open the wrapper script `submit_workflow.sh` to configure your experiment(s).
...
(5. Alternatively, you can call the batch submission directly from the command line:
    `sbatch <sbatch_options> ./workflow/run_workflow.sh --date <YYYYMMDD> --hours <NHRS> --res <CRES> --run-dir </PATH/TO/OUTPUT/DIR> --job-name <JOB_NAME>`)
